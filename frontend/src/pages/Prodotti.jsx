...
function Prodotti() {
  ...
  return (
    <>
      ...
      <form className="mb-[20px] p-4 border rounded">
        <div className="mb-[10px]">
          <label>Titolo</label>
          <input type="text" placeholder="Inserisci il titolo..." className="w-full p-2 border rounded"/>
        </div>

        <div className="mb-[10px]">
          <label>Descrizione</label>
          <textarea placeholder="Inserisci la descrizione..." className="w-full p-2 border rounded"></textarea>
        </div>
        
        <div className="mb-[10px]">
          <label>Prezzo</label>
          <input type="number" placeholder="Inserisci il prezzo..." className="w-full p-2 border rounded"/>
        </div>
